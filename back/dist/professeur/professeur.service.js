...
let ProfesseurService = class ProfesseurService {
    constructor(professeurRepository) {
    ...
    async findMatiereofProfesseur(idProfesseur) {
...
exports.ProfesseurService = ProfesseurService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(professeur_entity_1.Professeur)),
